...
const TaskSubmissionRepo = require('../repositories/task-submission.repository');
/* Router Methods */
...
exports.Index = async (req, res, next) => {
    ...
    try {
        let tasks = await TaskSubmissionRepo.Index(query, page, size);
...
exports.Add = async (req, res, next) => {
    ...
    try {
        let task = await TaskSubmissionRepo.Create(body);
